...
- `src/apps/molresponse_v2/MOLRESPONSE_TUTORIAL.md` (stage-oriented walkthrough)
- `src/apps/molresponse_v2/MOLRESPONSE_FUNCTION_REFERENCE.md` (function-by-function intent map)
