...
vector_real_function_3d CoupledResponseEquations(World& world, const GroundStateData& g_s,
    ...
    DEBUG_TIMED_BLOCK(world, &logger, "g0_task", { k_0 = g0_task(ii, state_index, vecs.flat, g_s.orbitals, true); });
    DEBUG_TIMED_BLOCK(world, &logger, "gx_task", { g_x = gx_task(ii, state_index, vecs.flat, g_s.orbitals, true); });
...
vector_real_function_3d CoupledResponseEquations(World& world, const GroundStateData& g_s,
    ...
    DEBUG_TIMED_BLOCK(world, &logger, "g0_task", { k_0 = g0_task(ii, state_index, all_x, g_s.orbitals, false); });
    DEBUG_TIMED_BLOCK(world, &logger, "gx_task", { g_x = gx_task(ii, state_index, all_x, g_s.orbitals, false); });
