...
void ExcitedResponse::iterate(World& world) {
  ...
  for (size_t b = 0; b < m; b++) {
    kain_x_space.push_back(XNonlinearSolver<vector_real_function_3d, double,
...
auto ExcitedResponse::bsh_update_excited(
    World& world, const Tensor<double>& omega, X_space& theta_X,
    QProjector<double, 3>& projector) -> X_space {
