...
public:
    ...
    [[nodiscard]] std::vector<std::string> perturbations() const {
        return get<std::vector<std::string>>("perturbations");
    }
    ...
    [[nodiscard]] bool tda() const {
        return get<bool>("tda");
    }
    [[nodiscard]] bool plot() const {
        return get<bool>("plot");
    }
    [[nodiscard]] bool step_restrict() const {
        return get<bool>("step_restrict");
    }
    [[nodiscard]] double plot_l() const {
        return get<double>("plot_l");
    }
    [[nodiscard]] size_t plot_pts() const {
    ...
    [[nodiscard]] bool guess_xyz() const {
    ...
    [[nodiscard]] bool plot_initial() const {
    ...
    [[nodiscard]] int loadbalparts() const {
    ...
    // convenience getters
    [[nodiscard]] double econv() const {
        return get<double>("econv");
    }
    [[nodiscard]] bool first_run() const {
        return get<bool>("first_run");
    }
    [[nodiscard]] std::string local() const {
