...
int main(int argc, char** argv){
    ...
    real_function_3d Vnuc=real_factory_3d(world).f(V).truncate_mode(0);//truncate V less than thresh
    real_function_3d psi=real_factory_3d(world).f(guess);// inital psi
